<x-jet-dropdown align="right" width="80">
    <x-slot name="trigger">
        <div x-data="{showUnreadNotifications : true}">
            <button
                ...
                x-on:click="showUnreadNotifications = false; Livewire.emit('readNotifications');">
    ...
    <x-slot name="content">
        <ul class="divide-y max-h-96 w-80 scroll-style overflow-y-auto pb-2" id="notif-container">
            ...
            @endforelse
            <x-jet-dropdown-link href="{{ route('notifications') }}" class="font-bold text-center text-gray-700">
                All Notifications & Transactions
            </x-jet-dropdown-link>
        </ul>
    </x-slot>
</x-jet-dropdown>
